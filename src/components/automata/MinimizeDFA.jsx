...
// Add this function before the MinimizeDFA component
const getCategoryColor = (category) => {
  ...
  return colors[category] || "bg-slate-100"; // Default color if category not found
};
                            ...
                            >
                              <td className="px-2 py-1">
                                <div className="flex gap-2">
                                  <span className="font-medium min-w-[2.5rem] flex items-center">
                                    {/* Show arrow for initial state and asterisk for accepting state */}
