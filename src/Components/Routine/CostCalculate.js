...
function CostCalculate() {
    ...
    const calculateCost = () => {
        const totalCost =
            (totalCredit * tuitionFeePerCredit + semesterFee + additionalCost) *
            ((100 - waiverPercentage) / 100);
        return totalCost;
    };
    ...
    return (
        <div className='' >
            <h2 className='text-center text-xl mt-10 text-rose-600'>Course Cost Calculator</h2>
            ...
            <h3 className='text-center text-xl mt-5'>Total Cost: <span className='font-bold text-rose-600'>{calculateCost()} tk.</span></h3>
            
            <h3 className='text-center '>approx per installment</h3>
            <h3 className='text-center '><span className='font-bold text-rose-600'>{Math.round(calculateCost() / 3)} tk.</span></h3>
